    ...
    public class OrpheusTable<T> : IOrpheusTable<T>
    {
        ...
        protected void executeDelete(IDbTransaction transaction)
        {
            ...
            foreach (var deleteRecord in this.deleteCommandValues)
            {
                ...
                {
                    this.logger.LogError(ErrorCodes.ERR_DELETING_DATA, e, $"{ErrorDictionary.GetError(ErrorCodes.ERR_DELETING_DATA)} | {this.deleteCommand.CommandText}");
                    throw;
                }
            }
        ...
        protected void executeUpdate(IDbTransaction transaction)
        {
            ...
            foreach (var updateRecord in this.updateCommandValues)
            {
                ...
                {
                    this.logger.LogError(ErrorCodes.ERR_UPDATING_DATA, e, $"{ErrorDictionary.GetError(ErrorCodes.ERR_UPDATING_DATA)} | {this.updateCommand.CommandText}");
                    throw;
                }
            }
        ...
        protected void executeInsert(IDbTransaction transaction)
        {
            ...
            foreach (var newRecord in this.insertCommandValues)
            {
                ...
                {
                    this.logger.LogError(ErrorCodes.ERR_INSERTING_DATA, e, $"{ErrorDictionary.GetError(ErrorCodes.ERR_INSERTING_DATA)} | {this.insertCommand.CommandText}");
                    throw;
                }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!disposed && disposing)
            {
                ...
                loadCommand?.Dispose();
                updateAutoGeneratedKeyValues?.Dispose();
                disposed = true;
            }
        }
        #endregion
        ...
        /// </summary>
        public async System.Threading.Tasks.Task LoadAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            await System.Threading.Tasks.Task.Run(() => ((IOrpheusTable)this).Load(), cancellationToken);
        }

        /// <summary>
        /// Asynchronously loads data using key-value pair filter.
        /// </summary>
        public async System.Threading.Tasks.Task LoadAsync(List<object> keyValues, System.Threading.CancellationToken cancellationToken = default)
        {
            await System.Threading.Tasks.Task.Run(() => Load(keyValues), cancellationToken);
        }

        /// <summary>
        /// Asynchronously saves all pending changes.
        /// </summary>
        public async System.Threading.Tasks.Task SaveAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            await System.Threading.Tasks.Task.Run(() => Save(), cancellationToken);
        }
        #endregion
    }
}
